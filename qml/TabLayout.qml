...
Item {
    ...
    readonly property var allowed_stack_components_:                        // list of allowed component names to be
            ["view_selector", "chartsLayout", "domainGraphLayout_component", "matchAnalysesView"]//  loaded in the tabs stack view
        ...
        Component {
            ...
            StackView {
                ...
                initialItem: customInitialItem == "chartsLayout" ? chartsLayout :
                        ...
                        customInitialItem == "matchAnalysesView" ? matchAnalysesViewComponent : view_selector
                ...
                Component {
                    ...
                    Rectangle {
                        Row {
                            ...
                            Button {
                                id: match_analyses_button
                                width: 400; height: 400
                                background: Rectangle {
                                    color: Theme.whiteSmoke
                                    border.width: 3
                                    border.color: match_analyses_button.hovered ? Theme.eProsimaLightBlue : Theme.eProsimaDarkBlue
                                    radius: 40
                                    Image {
                                        anchors.centerIn: parent
                                        anchors.verticalCenterOffset: -50
                                    ...
                                    Text {
                                        ...
                                        horizontalAlignment: Text.AlignHCenter
                                        font.pointSize: 20
                                        color: match_analyses_button.hovered ? Theme.eProsimaLightBlue : Theme.eProsimaDarkBlue
                                    }
                                }
                                anchors.verticalCenter: parent.verticalCenter
                                onClicked: {
                                    tabLayout.tab_model_[current_]["title"] = "Match Analyses"
                                    if (stack.deep > 1) {
                                        stack.pop()
                                    }
                                    stack.push(matchAnalysesViewComponent)
                                    refresh_layout(current_)
                                }
                            }
                        }
                ...
                Component {
                    id: matchAnalysesViewComponent
                    Loader {
                        anchors.fill: parent
                        source: "MatchAnalysesView.qml"
                        asynchronous: false
                    }
                }
            }
